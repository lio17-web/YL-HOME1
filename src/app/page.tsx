    ...
    <main className="min-h-screen flex flex-col justify-between bg-gradient-to-b from-white to-gray-100">
        ...
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-2xl font-bold">
              YL <span className="text-gray-500">HOME</span>
            </span>
          </div>

          {/* Liens */}
          <nav className="flex gap-6 text-gray-700 font-medium">
            <a href="#accueil" className="hover:text-gray-900">
              Accueil
            </a>
            <a href="#produits" className="hover:text-gray-900">
              Produits
            </a>
      ...
      <section id="accueil" className="max-w-6xl mx-auto px-4 py-16 text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-800">
          Bienvenue chez <span className="text-gray-500">YL HOME</span>
        </h1>
        <p className="mt-4 text-lg text-gray-600">
          Mobilier & décoration modernes pour un intérieur élégant
        </p>
      </section>
          ...
          {produits.map((p) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <a
                  href={`https://wa.me/213664794077?text=Je%20veux%20commander%20: ${encodeURIComponent(
                    p.nom
                  )}`}
                  target="_blank"
      ...
      >
        ...
        <p className="mt-2 text-gray-600">
          Disponible sur WhatsApp pour vos commandes et devis.
        </p>
      </section>
      ...
      <footer className="bg-gray-900 text-white mt-8">
        <div className="max-w-6xl mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6 text-xl">
            <a
              href="https://www.instagram.com/yl.home"
              target="_blank"
            ...
            <a
              href="https://www.tiktok.com/@yl.home13"
              target="_blank"
      ...
      <div className="fixed bottom-6 left-6 z-50">
        ...
        >
          ...
          {showMessage && (
            <span className="animate-bounce">Cliquez pour commander</span>
          )}
        </a>
      </div>
    </main>
